...
var UserController = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, User_1.User.findOne({ where: { username: loginData.username } })];
                    case 1:
                        user = _a.sent();
                        console.log(user);
    ...
    UserController.prototype.getUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, User_1.User.findOne(req.params.id)];
                    case 1:
                        client = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, User_1.User.update(req.params.id, req.body)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, res.status(200).send({ message: 'User updated correctly' })];
                    case 3: return [2 /*return*/, res.status(404).send({ message: 'User not found' })];
                }
            });
        });
    };
    UserController.prototype.deleteUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, User_1.User.delete(req.params.id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, res.status(200).send({ message: 'User deleted successfully' })];
                }
            });
        });
    };
